...
import { TheirStackService } from "./theirstack";
...
export { TheirStackService } from "./theirstack";
 ...
 *
 * @param serviceName - The service name (apollo, signalhire, snovio, instantly, apify, zapi, theirstack)
